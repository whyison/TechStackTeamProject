...
def crawler():
    ...
    jobs = {'소프트웨어 엔지니어': 10110, '웹 개발자': 873, '서버 개발자': 872, '프론트엔드 개발자': 669, '자바 개발자': 660,
            'C,C++ 개발자': 900, '파이썬 개발자': 899, '머신러닝 엔지니어': 1634, '데이터 엔지니어': 655, '안드로이드 개발자': 677,
            'Node.js 개발자': 895, '시스템, 네트워크 관리자': 665, 'DevOps / 시스템 관리자': 674, 'iOS 개발자': 678,
            '임베디드 개발자': 658, '개발 매니저': 877, '기술지원': 1026, '데이터 사이언티스트': 1024, 'QA, 테스트 엔지니어': 676,
            '하드웨어 엔지니어': 672, '빅데이터 엔지니어': 1025, '보안 엔지니어': 671, '프로덕트 매니저': 876,
            '크로스플랫폼 앱 개발자': 10111, 'DBA': 10231, '블록체인 플랫폼 엔지니어': 1027,
    ...
    for job in jobs:
        url = 'https://www.wanted.co.kr/wdlist/518/{}?country=kr&job_sort=job.latest_order&years=0&locations=all'.format(
            jobs[job])
        ...
        for company in companies:
            company_links.append(driver.execute_script("return arguments[0].getAttribute('href');",
                                                       company.find_element(By.TAG_NAME, 'a')))
        ...
        for link in company_links:
            ...
            company_location = driver.find_element(By.XPATH,
                                                   '//*[@id="__next"]/div[3]/div[1]/div[1]/div/div[2]/section[2]/div[2]/span[2]')
